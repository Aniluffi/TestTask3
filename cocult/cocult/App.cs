        ...
        public void Run()
        {
            ...
            while (true)
            {
                ...
                switch (numDeist)
                {
                    ...
                    case 13:
                        Console.Clear();
                        Console.WriteLine($"Сумарная площадь многоугольников - {listEnteredShapes.S<Polygon>()}");
                        break;
                    case 14:
                        Console.Clear();
                    ...
                    case 18:
                        Console.Clear();
                        Console.WriteLine($"Сумарная периметров многоугольников - {listEnteredShapes.S<Polygon>()}");
                        break;
                    case 19:
                        Console.Clear();
